...
<div class="content delete">
	<h2>Delete experience #<?=$experience['id']?></h2>
    <?php if ($msg): ?>
    <p><?=$msg?></p>
    <?php else: ?>
	<p>Are you sure you want to delete experience #<?=$experience['id']?>?</p>
    <div class="yesno">
        <a href="delete.php?id=<?=$experience['id']?>&confirm=yes">Yes</a>
        <a href="delete.php?id=<?=$experience['id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
