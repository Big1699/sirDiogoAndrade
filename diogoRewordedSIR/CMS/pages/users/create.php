                            ...
                            <div class="col-md-6 col-lg-12 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <select name="role"class="form-select form-control form-control-lg <?php echo (!empty($role_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $rolenew; ?>" aria-label="Default select example" required>
                                            <option>Selecione o role de utilizador</option>
